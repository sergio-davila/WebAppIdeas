...
public class Glider {
    ...
    public Glider(long id, int weight, int acceleration, int on_road_traction, int off_road_traction, int mini_turbo, int ground_speed, int water_speed, int anti_g_speed, int air_speed, int ground_handling, int water_handling, int anti_g_handling, int air_handling) {
        this.id = id;
        this.weight = weight;
    ...
    public Glider(int weight, int acceleration, int on_road_traction, int off_road_traction, int mini_turbo, int ground_speed, int water_speed, int anti_g_speed, int air_speed, int ground_handling, int water_handling, int anti_g_handling, int air_handling) {
        this.weight = weight;
        this.acceleration = acceleration;
        this.on_road_traction = on_road_traction;
        this.off_road_traction = off_road_traction;
